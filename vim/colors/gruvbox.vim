...
let s:gb.bright_aqua    = ['#b1fd00', 108]     " 142-192-124
...
let s:gb.neutral_aqua   = ['#8bfea4', 72]      " 104-157-106
...
let s:gb.faded_purple   = ['#8f3f71', 96]      "	#8bfea4 143-63-113
let s:gb.faded_aqua     = ['#5fcda4', 66]      " 66-123-88
